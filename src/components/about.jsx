		...
		<section className="aboutMain" id="About">
			<div className="aboutContent">
				...
				<p>
					...
					sprawling well-maintained lawns, you are sure to be mesmerized by the
					charm of Jawahar Bhawan. Being an ode to the former prime minister
					Pandit Jawaharlal Nehru, the administration made sure to not skimp on
