const data = [
	...
	{
		name: "Washing Room",
		description: "Focusing on making the students fully independent adults, Jawahar Bhawan provides them with a laundry room, with an optimum number of fully automatic washing machines installed. We also have a paid washerman in the bhawan who comes on two days in Bhawan i.e.Wednesday and Sunday." ,
		flexDirection: "row-reverse",
		vector: "laundry-machine 1.svg",
		img: "default.png"
	},
	
	{
		name: "Jawahar Club",
		description:"Jawahar Bhawan boasts its club - Jawahar Club - an alternative to those who find going to the student’s club tiresome. With the only bhawan to have its own club with billiards and pool tables, it is one of the best places for students to wind down after a hectic day. It also has facilities for foosball, table tennis, carrom, chess and much more.",
		flexDirection: "row",
		vector: "snooker 1.svg",
		img: "default.png"
	},
	
	{
		name: "Guest Room",
		description:"With guest rooms available at demand, you will not be needed to undergo the lengthy booking procedures of any hotel. Moreover, it's helpful in cases when you forget to book a hotel after all we know how busy a student’s life is; academics, clubs",
        flexDirection: "row-reverse",
		vector: "accomodation 1.svg",
		img: "default.png"
	},
